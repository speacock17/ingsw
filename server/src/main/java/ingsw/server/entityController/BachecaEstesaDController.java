...
import ingsw.server.entityDAO.BachecaEstesaDviewDAO;
...
public class BachecaEstesaDController extends SuperController{
    public BachecaEstesaDController(JdbcTemplate jdbcTemplate) {
        super(jdbcTemplate);
    }
    ...
    public ResponseEntity<String> mostraTuttaBacheca(){
        ...
        try{
            BachecaEstesaDviewDAO dao = new BachecaEstesaDviewDAO(connection);
